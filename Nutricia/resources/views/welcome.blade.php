    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          <h2 data-aos="fade-up">Let Experts Take Care<br>of Your Health & Wellness</h2>
          <p data-aos="fade-up" data-aos-delay="100">Take control of your goals. Track calories, break down ingredients.</p>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a href="dietpackages" class="btn-book-a-table">Subscibe Now</a>
          </div>
        </div>
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <img src="https://food-guide.canada.ca/themes/custom/wxtsub_bootstrap/images/food_guide_visual_en.png" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300">
        </div>
      </div>
    </div>
